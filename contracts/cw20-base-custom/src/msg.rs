...
use crate::state::LockAddressMsg;
...
pub enum ExecuteMsg {
    ...
    /// Update operator address for lock address
    UpdateOperator { 
        new_operator: String,
    },
}
...
pub enum QueryMsg {
    ...
    DownloadLogo {},
    /// lock address
    #[returns(crate::state::LockAddressResponse)]
    LockAddressList {
        include_expired: bool,
        start_after: Option<String>,
        limit: Option<u32>,
    },
    #[returns(crate::state::LockAddressInfo)]
    LockAddressInfo {
        address: String,
    },
}
